class SignupPage {
  ...
  go() {
    //isso é uma função e não precisa colocar o nome function antes. Essa função faz uma verificação inicial
  ...
  modalContextShouldbe(expectedMessage) {
    //passa novamente a variável como função
    cy.get('.swal2-container .swal2-html-container').should(
      'have.text',
      expectedMessage,
    ) // esse cy.get que tem css selector usando ponto é mais uma forma de pegar um elemento, então ao inves de fazer usando uma div, como div[class="swal2-popup swal2-modal swal2-icon-success swal2-show"], podemos usar o ponto para nagevar em cada elemento
  }
}
